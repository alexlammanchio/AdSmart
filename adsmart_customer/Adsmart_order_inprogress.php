...
<div class="small-container cart-page " style ="padding-bottom:550px; ">
		...
		<h1>Order Status</h1>             
           ...
           if(isset($_SESSION['update']))
    			...
    			?>
           <?php 
            $sql= "select * from payment where cus_user_id = '$account_name' and order_status != 'completed' ";
			...
			if ($rows['transaction_id'] !== $previousTransactionId) {
			    ...
			    echo "<td>";
			    echo "<a href='" . ADSMART_CUSTOMER . "Adsmart_order_info.php?trans_id=" . $rows['transaction_id'] . "'>";
