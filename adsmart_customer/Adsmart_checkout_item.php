...
<div class="small-container cart-page" style ="padding-bottom:500px;">
		...
		<h1>Checkout Items</h1>      
           ...
           $sql1 = "select a.req_number from quotation_content a join payment b on a.req_number = b.req_number where a.customer_name = '$account_name'";
				   ...
				   <th> Action</th>
                    ...
                    while($rows=mysqli_fetch_assoc($res))
                    {
                        ...
                        if ($rows['req_number'] !== $previousTransactionId) {
                            ...
                            echo "<td>";
                            echo "<a href='" . ADSMART_CUSTOMER . "Adsmart_checkout_item_info.php?req_number=" . $rows['req_number'] . "'>";
