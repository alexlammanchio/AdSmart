...
<div class="small-container cart-page" style="width:800px;margin-bottom:250px;">
		...
		<h1>Create An Advertisement Request</h1>   
    		...
    		<div class="reg-container">	
					          <form action="../adsmart_customer/handle_create_new_adsrequest.php" method="post">
					            <table >
											<tbody>
												<tr>
												...
												<tr>
												    ...
												    <?php 
												      ...
												      <div id="customer_id">
												    	...
												    	<?php 
												    	$sql2 = "SELECT req_number FROM qoutation ORDER BY  create_datetime DESC,  req_number ASC LIMIT 1";
