...
<h1 style="color:#333; text-align:center;">AdSmart Business Partners Profile </h1>
		...
		<div class="reg" >			
           ...
           <?php 
			 ...
			 <a href="<?php echo USER_MANAGEMENT; ?>update-partner-info.php?id=<?php echo $id2; ?>" class="btn" style="background:#9198e5; width:120px; height:80px;font-size:16px;">Update Account Info</a>				 
				  <a href="<?php echo USER_MANAGEMENT; ?>update-partner-bankinfo.php?id=<?php echo $id2; ?>" class="btn" style="background:#9198e5; width:120px; height:80px;font-size:16px;">Update Bank Info </a> 
				 <a href="<?php echo USER_MANAGEMENT; ?>update-partner-preference.php?id=<?php echo $id2; ?>" class="btn" style="background:#9198e5; width:160px; height:80px;font-size:16px;">Update Service & Product Types</a>
			 <a href="<?php echo USER_MANAGEMENT; ?>update-partner-password.php?id=<?php echo $id2; ?>" class="btn" style="background:#9198e5; width:180px; height:80px;font-size:16px;">Change AdSmart Business Parnter Password</a>
		</div>
