    ...
    echo 
		...
		<div class='reg' >
				<h2>AdSmart Business Partner Login</h2>
						...
						<br>
						<br>
						<p style='color:black; font-size:24px;'> Click this Here to <a style='color:blue;' href='Adsmart_partners_personal_space.php' >AdSmart Business Parnter Personal Space page!</a></p>.
		</div>
</div>";
       }
?>
