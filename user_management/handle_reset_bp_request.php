...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if (isset($_POST['reset-request-submit'])) {
        ...
        $url = "http://localhost/adsmart/user_management/create-bp-new-password.php?selector=".$selector."&validator=".bin2hex($token);
        ...
        header('Location:'.USER_MANAGEMENT.'reset-password.php?reset=success');
        }catch (Exception $e) {
