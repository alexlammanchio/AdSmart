...
<div style="background:#1b0075">
              ...
              <div class='container-fluid' style ='padding-bottom:530px;'>
            	   	<div class='reg' style='width: 1000px; margin-top:170px;'>
	   	<div class='reg'>
			<h1>Change AdSmart Business Partner Password </h1>
			<br>
			<br>
			<?php 
			 if(isset($_GET['id']))
			...
			<form action="handle_partner_update_password.php" method="POST">
					<table class="tbl-30">
					<tr>
