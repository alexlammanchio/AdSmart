...
<h1 style="color:#333; text-align:center;">AdSmart Customer Profile </h1>
		...
		<div class="reg" >			
           ...
           <?php 
			 ...
			 <a href="<?php echo USER_MANAGEMENT; ?>update-customer-info.php?id=<?php echo $id2; ?>" class="btn" style="background:#9198e5; width:120px; height:80px;font-size:16px;">Update Account Info</a>				 
				  <a href="<?php echo USER_MANAGEMENT; ?>update-customer-creditcard.php?id=<?php echo $id2; ?>" class="btn" style="background:#9198e5; width:130px; height:80px;font-size:16px;">Update Credit Card Info </a> 
				 <a href="<?php echo USER_MANAGEMENT; ?>update-customer-preference.php?id=<?php echo $id2; ?>" class="btn" style="background:#9198e5; width:180px; height:80px;font-size:16px;">Update Customer's Preference</a>
			 <a href="<?php echo USER_MANAGEMENT; ?>update-customer-password.php?id=<?php echo $id2; ?>" class="btn" style="background:#9198e5; width:180px; height:80px;font-size:16px;">Change AdSmart Customer Password</a>
		</div>
