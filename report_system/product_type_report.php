...
// bar chart
$barDataQuery3 = "SELECT  item_name, sum(total) as total_amount from payment a join adsmart_business_product b on a.item_name = b.product_name  where a.company_user_id ='$account_name' group by a.item_name;
