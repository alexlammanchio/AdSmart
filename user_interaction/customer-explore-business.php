		...
		<div class="col-2">
			...
			<?php 
            				        ...
            				        <input type='submit' value='Add to Cart'   name='submit' class='btn'  style= 'font-size:20px;background: Red; width:400px;margin-left:115px;'>
            				         <a href='<?php echo USER_INTERACTION; ?>Adsmart_customers_send_requirement.php?company_id=<?php echo $id;?>' class='btn' style= 'font-size:20px;background: blue;height:40px;width:400px;margin-left:115px;'> Send A Requiremnt</a>
				...
				echo	"<h4>".$row2['company_name']."</h4>";
			      echo "<br>";
					echo "<b>Description:	</b> <p style='color:blue;'>".$row2['description']."<p>";				
						echo "<a href='".USER_INTERACTION."customer-explore-business.php?id=".$id."'   > <button type='button' class='btn' style='background:#9198e5'>Detail</button> </a>";
						echo "</div>";
				}
				}
