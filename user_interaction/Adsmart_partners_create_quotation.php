					          ...
					          <form action="handle_create_quotation.php" method="post">
					            <table >
											<tbody>
												...
												<tr>
												    ...
												    <?php 
												      ...
												      <div id="requirement">
												    	...
												    	<br>
												    	<?php 
												    	if($customer_action =='accept'){
												    	echo " <fieldset style='padding-left:15px;'><legend>User's Answer</legend>
												      <br>
												      	
												    	<div id='requirement'>
												    	
													    	<label>Leave Comment:</label><br>";
													    	echo "<textarea  id ='myTextarea2' name='customer_comment'>".$customer_comment."</textarea>
												...
												<br>";}else{
												echo "<fieldset style='padding-left:15px;'><legend>Discussion's information</legend>";
...
inner join qoutation as c  on b.qoutation_id = c.id
 where  b.qoutation_id='$id' ";
    $res3 = mysqli_query($conn, $sql3);
