...
<div style="background:#1b0075">
 ...
 from topics a join qoutation b on a.qoutation_id = b.id WHERE a.qoutation_id='$qoutation_Id'";
    ...
    if ($row) {
        ...
        ELSEIF($product_name != ''){
            ...
            echo "<h1> Product Name: ".$row['product_name']."</h1>";
 ...
 <fieldset style="padding-left:15px;"><legend>Customer Request's information</legend>
													    ...
													    echo "<p style='text-transform:none; font-size:18px; text-align:left; margin-top:80px;'><strong style='color:blue; ' >Company Name: </strong> ".$company_name."</p>";
													    ...
													    echo "<p style='text-transform:none; font-size:18px; text-align:left;'><strong style='color:blue;' >Reply Date:</strong> ".$create_datetime."</p>";		
													    	...
													    	<?php 
													    	echo "<p style='text-transform:none; font-size:18px; text-align:left;'><strong style='color:blue;' >Company wants to charge:</strong> $".$company_price."</p>";		
													    	...
													    	<br>
													    	<p style='text-transform:none; font-size:18px;  text-align:left;'><strong style='color:blue;' >Business Partner Implemetation Plan:</strong></p>
													    	<script src="tinymce/tinymce.min.js">
    ...
    $sql3 ="SELECT *, a.content as reply_content, a.created_dt as reply_date, a.customer_name, a.company_name, a.status from replies a join topics b on a.topic_id= b.id
...
<br>
    ...
    if($status =='progress' || $status =='NA' || $status =='' ){
        echo "<form action='handle_create_new_cs_reply.php' method='post'>";
        echo "<input type='hidden' name='topic_id' value='.$topic_id.'>";
        echo "<input type='hidden' value=".$customer_name." name='customer_name' >";
        echo  "<input type='hidden' value=".$customer_id." name='customer_id' >";
        echo  "<input type='hidden' value=".$qoutation_Id." name='qoutation_Id' >";
        
        echo "<p style='font-size:30px;'><b>If the discussion has a result, please choose ticket status:</b></p>
        <br>";
        echo "<select required name='customer_action' style= 'height:50px; font-size:20px;' >";
        echo "<option value=''>Select One</option>";
        echo "<option value='accept'>Complete and Need a Quotation</option>";
        echo "<option value='reject'>Reject</option>";
        echo "</select>";
        
        echo "<input  style='background:#096f04; color:white; width:250px; height:50px; text-align:center; font-size:25px;border-radius: 10px;' type='submit' value='Update'>";
    ...
    echo  "</form>";  
        ...
        echo "<b style='color:Black; font-size:25px;'> Waiting for Business Partner To Send A Quotation! </b>";
        
    }else {
        echo "<b style='color:Red; font-size:25px;'> This Ticket has been rejected.</b>";
    }?>
