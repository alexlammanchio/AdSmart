...
if (isset($_POST["submit"])) {
    ...
    if(isset($_FILES['uploadedFile']['name'])){
        ...
        if($filename !=""){
            ...
            // 重命名PDF文件
            $filename ="Business_Partner_PDF".rand(000,999).'.'.$ext;
            
            $source_path = $_FILES['uploadedFile']['tmp_name'];
            $destination_path = "../pdf/business_partner/".$filename;
            ...
            // 插入PDF文件的详细信息到数据库
            $sql = "Update quotation_content set bp_filename ='$filename', bp_size ='$fileSize', bp_type ='$fileType', bp_file_upload_date = '$created_time'
