												...
												<tr>
												    ...
												    <?php 
												      ...
												      <div id="customer_id">
													    ...
													    echo "<p style='text-transform:none; font-size:18px;'><strong style='color:blue;' >Ticket Name:</strong> ".$ticket_number."</p><br>";		
													    echo "<p style='text-transform:none; font-size:18px;'><strong style='color:blue;' >Create Date:</strong> ".$create_date."</p>";
												      ...
												      <div id="req">
													    ...
													    <?php 
													    echo "<input type='hidden' value='".$reply_date."' name='reply_date' readonly style='color:Green; font-size: 16px; width:450px;height:30px; font-weight:bold; border: 2px solid black;'>";
													    echo "<p style='text-transform:none; font-size:18px;'><strong style='color:blue;' >Reply Date: </strong> ".$reply_date."</p>";		
													    ?>
													    	<br>
													    </div>		
												      ...
												      <br>
													    ...
													    <div id="action">
													    	...
													    	<option value="discuss">Need to Discuss with Supplier</option>
