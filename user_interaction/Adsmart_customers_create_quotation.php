...
<!-- -Cart Items Details -->
<div class="small-container cart-page" style="width:800px;margin-bottom:250px;">
		<div class="reg">		
		
		<h1>Create An Advertisement Request</h1>   
    		
    		<div class="reg-container">	
					          <form action="../user_interaction/handle_create_new_adsrequest.php" method="post">
					            <table >
											<tbody>
												<tr>
												...
												<tr>
												    ...
												    <?php 
												      ...
												      <div id="customer_id">
												    	...
												    	<?php 
												    	$sql2 = "SELECT req_number FROM qoutation ORDER BY    req_number DESC,create_datetime DESC LIMIT 1";
												    	...
												    	<div id="user_id">
													    	...
													    	<label><b style="color:red;">*</b>Adverisement Type: </label>
													    	<?php 
													    	...
													    	?>
													    	<?php 
													    	echo "<select required name='category_id'>";
													    	...
													    	while($row = mysqli_fetch_array($res) ) {
													    	    ...
													    	    echo  "<option value='".$row['id']."' name='".$row['category_name']."'>";
													  ...
													  ?>
													    ...
													    <div id="subject">
													    	...
													    	<label><b style="color:red;">*</b>Subject:</label>
													    	 ...
													    	 <input required type="text"  name="subject" style=" font-size: 10px; width:450px;height:30px; font-weight:bold;" placeholder="please input the subject" >
