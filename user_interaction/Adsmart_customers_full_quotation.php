											...
											<tbody>
												...
												<tr>
												    ...
												    <?php 
													    	...
													    	$sql1 = "SELECT *, a.id as req_no, a.subject as q_subject,
                                                             case budget 
												      ...
												      <div id="ticket_id">
													    ...
													    echo "<input type='text' value='".$subject."' name='subject' readonly style=' color:Green; font-size: 16px; width:450px;height:30px; font-weight:bold;border: 2px solid black;'>";
													        ...
													        echo "<input type='text' value='".$product_name."' name='product_name' readonly style=' color:Green; font-size: 16px; width:450px;height:30px; font-weight:bold;border: 2px solid black;'>";
												      ...
												      <div id="req">
												    	...
												    	$customer_reply_date = $row3['reply_date'];
												    	...
												    	<div id="implementation">
													    	...
													    	<?php 
													    echo " <textarea required id='myTextarea1'  name='implementation' rows='14' cols='65' readonly>";
													    echo $implementation;
													    echo	"</textarea>";
												      ...
												      <br>
												    	...
												    	<div id="requirement">
													    	...
													    	<?php 
													    	echo "<textarea  id='myTextarea2'  name='customer_comment' rows='14' cols='65' readonly>";
													    ...
													    <div id="action">
													   	...
													   	?>
													    	...
													    	<label><b style="color:red;">*</b>Customer Reply Date: </label>
													    	<?php 
													    	echo "<input type='text' value='".$customer_reply_date."' name='customer_action' readonly style='color:Green; font-size: 16px; width:450px;height:30px; font-weight:bold; border: 2px solid black;'>";
													   	?>
												...
												$dt = date('Y-m-d');
												if($deadline_date <$dt){
												    echo "<b style='color:red; font-size:30px;'><a href='" . USER_MANAGEMENT . "Adsmart_customers_personal_space.php?page=3'>The ticket is Expired</a></b>";
												
												}
												elseif($customer_action =='accept'){
												    echo  	"<div id='button'>";
												    echo "<b><a href='" . USER_MANAGEMENT . "Adsmart_customers_personal_space.php?page=3' style='color:green;'>You accept this ticket!</a></b>";
												    echo  "</div>";
												}elseif ($customer_action =='reject'){
												    echo "<b style='color:red; font-size:30px;'><a href='" . USER_MANAGEMENT . "Adsmart_customers_personal_space.php?page=3'>You Rejected this offer!</a></b>";
												}
