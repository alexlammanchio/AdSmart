...
<?php 
        ...
        ('$company_name', '$company_id', '$customer_name', '$product_name', '$price1', '$quantity')";
    	    ...
    	    if($res2==true){
    	        ...
    	        $_SESSION['update'] ="<div style='color:green; font-size:28px;'> Item has been added Shopping cart successfully. </div>";
    	        header('location:'.USER_INTERACTION.'customer-explore-business.php?id='.$company_id);
    	    }else{
