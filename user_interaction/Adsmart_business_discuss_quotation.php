...
<div style="background:#1b0075">
 ...
 <fieldset style="padding-left:15px;"><legend>Customer Request's information</legend>
													    ...
													    <textarea id='myTextarea' name='requirement'><?php echo htmlspecialchars($requirement); ?></textarea>
 ...
 where a.topic_id='$topic_id' ";
    ...
    echo  "</form>";  
        ...
        echo "<b style='color:Black; font-size:25px;'>The request has been accepted! Please Click <a href='".USER_INTERACTION."Adsmart_partners_create_quotation.php?id=".$qoutation_Id." '><b style='color:blue;'>here </b></a> to generate a contract! </b>";
        
    }elseif($row4['status'] =='accept' && $bp_filename != 'NA') {
        echo "<b style='color:Black; font-size:25px;'>The request has been accepted! Please Click <a href='".USER_INTERACTION."Adsmart_partners_after_created_quotation.php?id=".$qoutation_Id." '><b style='color:blue;'>here </b></a> to check the status of contract! </b>";
    }    
