...
if($_SERVER["REQUEST_METHOD"]=="POST"){    
    ...
    $sql = "INSERT INTO replies (topic_id,user_id, customer_name, company_name, company_id, content, created_dt,status)
          VALUES ('$topic_id','$customer_id', '$customer_name', '$company_name', '$company_id', '$content', '$created_dt','$customer_action')          
             ";
    ...
    if($res==TRUE)
    {
        ...
        header('location:'.USER_INTERACTION.'Adsmart_customers_discuss_quotation.php?qoutation_id='.$qoutation_Id);
        //Redirect Page
