...
<div style="background:#1b0075">
	   	...
	   	<div class='reg'>
    		...
    		<h1>Update Service & Product Types Information</h1>
    		<br>
    		<br>
    		...
    		<?php 
    		  ...
    		  if(isset($_GET['id']))
    		  {
    		      ...
    		      if($count ==1)
    		      {
    		          ...
    		          header('location:'.ADSMART_BUSINESS.'Adsmart_customers_personal_space.php?page=6');
    		...
    		<form action="handle_partner_update_preference.php" method="POST" enctype="multipart/form-data">
    		<table class="tbl-30">
    			<tr>
    				<td>Company Name: </td>
    				<td>
    			...
    			<tr>
    				<td>Can Provide Traditional Ads: </td>
    				<td>
    					Status
    				</td>   				
    			...
    			<tr>
    				<td>Can Provide AdSmart Product: </td>
    				<td>
    					Status
    				</td>   				
