				     ...
				     if($count>0){
			            ...
			            <td><?php echo $sn++; ?></td>
                    					...
                    					?>
                    					 ...
                    					 <?php echo $active; ?>
                    					<br>
                    					<td> <?php echo "<a href='update_partners_products.php?product_id=" . $rows['id'] . "' class='btn' style='background:#9198e5;'>Update</a>"; ?>
				     <a href="<?php echo ADSMART_BUSINESS; ?>handle_business_delete_product.php?id=<?php echo $rows['id']; ?>&image_name=<?php echo $image_name; ?>"   class="btn" style="background:red;"> Delete </a></td>
                    					</td>
                    	</tr>
                    	<?php 
			        }
