...
// bar chart
$barDataQuery = "SELECT  cus_address as country, sum(total) as total_amount from payment  where company_user_id ='$account_name' group by cus_address ;
";$barDataStmt = $pdo->query($barDataQuery);
$barData = $barDataStmt->fetchAll();
$barJsonData = json_encode($barData);

// bar chart
$barDataQuery2 = "SELECT  month(created_day) as month, sum(total) as total_amount from payment  where company_user_id ='$account_name' group by month(created_day) ;
...
<div id="barChartContainer">
    <h1>Revenues From Customer's country</h1>
