												...
												<tr>
												    ...
												    <?php 
												      ...
												      <div id="customer_id">
													    ...
													    <?php 
													    echo "<input type='text' value='".$create_date."' name='create_date' readonly style=' color:Green; font-size: 16px; width:450px;height:30px; font-weight:bold;border: 2px solid black;'>";
												    	...
												    	<?php if(!empty($type)){													      
													        ...
													        echo "<p style='text-transform:none; font-size:18px;'><strong  >Advertisement Type:</strong> ".$type."</p>";														      
													        echo "<br>";
												     ...
												     <div id="requirement">
												    	...
												    	<div >
													    	...
													    	<?php 
													    	 echo "<textarea  id ='myTextarea1' name='requirement'>".$implementation."</textarea>"; 
