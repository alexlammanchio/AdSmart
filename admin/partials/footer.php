		...
		<div class="container">
			<div class="row">
					<div class="footer-col-1">									
							<p> <b>AdSmart Address: </b>Macao Green Island second 20 K</p>
							<br>
							<p> <b>AdSmart Tel: </b>(853) 6666 8888</p>
							<br>
							<p> <b>AdSmart Fax: </b>(853) 2866 8888</p>
							<br>
							<p> <b>AdSmart Email: </b>adsmart_hd@adsmart.com</p>
							
					</div>
					<div class="footer-col-2">									
							<img src="images/AdSmart_logo.png" style="width:100px; height:100px;">
							<p style="color:#fff;">AdSmart E-Commerce Platform for Advertisement Services</p>
							<br>
							<br>
					...
					<div class="footer-col-3">
							<h3>AdSmart IT information</h3>									
							<ul>
								<li><b style="color:#fff;font-size:15px;">Hotline: 2888 3333</b></li>
								<li><b style="color:#fff;font-size:15px;">Email: AdSmart-IT@adsmart.com</b></li>
			...
			<hr>
			<p class="copyright"> Copyright 2023 <br>CISC9176 Applied Thesis - 2023: MB85505-1 Alex Lam</p>
