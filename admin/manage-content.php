<?php  include('partials/menu.php')?>
	   ...
	   <div class='small-container cart-page'>
	   	<div class='reg'>
			<h1>AdSmart Content Management </h1>
    			<br>
    			<br>
    			<?php 
    			...
    			<table class="tbl-full">
    				...
    				<?php 
    				    ...
    				    $sql ="SELECT * from content where active ='Yes' order by name";
    				    ...
    				    if($count>0){
    				        ...
    				        while($rows=mysqli_fetch_assoc($res))
    				        {
    				            ...
    				            $created_username=$rows['created_username'];
    					...
    					<td><?php //check image is existed or not
    				            if($image_name!=""){
    				                    ...
    				                    //display image
    				                ?>
    				                <img src="<?php  echo ADMIN;?>admin/images/content/<?php echo $image_name;?>" width="150px">
    				                <?php 
    					...
    					<td><a href="<?php echo ADMIN; ?>admin/update-content.php?id=<?php echo $id; ?>" class="btn-backend-2">update content</a>
    						<a href="<?php echo ADMIN; ?>admin/delete-content.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-backend-3">delete content</a>
    					</td>
    				</tr>    				
    			...
    			<a href="<?php echo ADMIN; ?>admin/add-content.php" class="btn" style="background:#9198e5; width:80%; height:50px;font-size:25px;">Add Content</a>
			</div>
		</div>
