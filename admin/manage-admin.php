    				        ...
    				        if($count>0){
    				            ...
    				            // get individual data
    				                ...
    				                <tr>
                    					...
                    					<a href="<?php echo ADMIN; ?>admin/update-password.php?id=<?php echo $id; ?>" class="btn-backend-1">change password</a>
                    					<a href="<?php echo ADMIN; ?>admin/update-admin.php?id=<?php echo $id; ?>" class="btn-backend-2">update Admin</a>
                    						<a href="<?php echo ADMIN; ?>admin/delete-admin.php?id=<?php echo $id; ?>" class="btn-backend-3">delete Admin</a>
                    					</td>
                					</tr>
