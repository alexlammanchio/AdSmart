...
<div class="small-container cart-page" style ="margin-bottom:600px;">
		...
		<h1>Commission Detail</h1>             
           ...
           $company_user_id = $_GET['id'];
            $sql= "select * from payment where order_status = 'completed' and company_user_id = '$company_user_id' LIMIT $start, $limit ";
    ...
    <?php endif; ?>
				...
				<a href="<?php echo ADMIN; ?>admin/business_partner_detail.php" class="btn-backend-3" style='width:500px;'>Go back to Business Partner Transaction Page</a>
		</div>
