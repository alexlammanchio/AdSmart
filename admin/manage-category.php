	   ...
	   <div class='small-container cart-page'>
	   	<div class='reg'>
			<h1>AdSmart Category Management </h1>
    				...
    				<?php 
    					...
    					<td><?php //check image is existed or not
    				            if($image_name!=""){
    				                    ...
    				                    //display image
    				                ?>
    				                <img src="<?php  echo ADMIN;?>admin/images/category/<?php echo $image_name;?>" width="150px">
    				                <?php 
    					...
    					<td><a href="<?php echo ADMIN; ?>admin/update-category.php?id=<?php echo $id; ?>" class="btn-backend-2">update Category</a>
    						<a href="<?php echo ADMIN; ?>admin/delete-category.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-backend-3">delete Category</a>
    					</td>
    				</tr>    				
    			...
    			<a href="<?php echo ADMIN; ?>admin/add-category.php" class="btn" style="background:#9198e5; width:80%; height:50px;font-size:25px;">Add Category</a>
			</div>
		</div>
