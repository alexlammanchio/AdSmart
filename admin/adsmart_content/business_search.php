			        ...
			        ?>
			           ...
			           <br>
                            ...
                            <br>
                               ...
                               <br>
                               <h3><b style="color:Green;">Countrye:</b><?php  echo $country; ?></h3>
                                 <a href="<?php echo SITEURL; ?>explore-business.php?id=<?php echo $id; ?>" class="btn" style="background:#9198e5; width:120px; height:40px;font-size:16px;">Explore</a>
