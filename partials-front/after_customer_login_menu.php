...
<div class="navbar">
    <nav>
      ...
      <div class="logo"><a href="#">ADSMART</a></div>
        <ul class="links">
	         ...
	         <li><a href="<?php  echo SITEURL;?>products-category.php" >Products</a></li>	        
	          ...
	          <li>
	            <a href="<?php  echo USER_MANAGEMENT;?>Adsmart_customers_personal_space.php" >Personal Space</a>	            
	          </li>
	          ...
	          <li><a href="<?php  echo USER_MANAGEMENT;?>logout.php" >Logout</a></li>
	         <li><a href="<?php  echo USER_INTERACTION;?>cart.php" ><i class="fas fa-shopping-cart"></i></a></li>  
      ...
      <a href="<?php  echo USER_MANAGEMENT;?>Adsmart_customers_personal_space.php" style="color:black; text-transform: uppercase;"><?php echo $_SESSION['user1']; ?> </a>
