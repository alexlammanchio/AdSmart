    ...
    <nav>
      ...
      <div class="logo"><a href="#">ADSMART</a></div>
        <ul class="links">
	         ...
	         <li>
	            <a href="<?php  echo USER_MANAGEMENT;?>Adsmart_partners_personal_space.php" >Personal Space</a>	            
	          </li>
      ...
      <a href="<?php  echo USER_MANAGEMENT;?>Adsmart_partners_personal_space.php" style="color:black; text-transform: uppercase;"><?php echo $_SESSION['user2']; ?> </a>
