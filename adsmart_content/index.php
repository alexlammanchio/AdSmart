...
<div class="small-container" >
			<div class="row" >
				<div class="col-2">
					...
					<a href="products-category.php" class="btn" style="background:#051986;"> Explore Now</a>
					<div class="col-2">
				...
				<div class="row">				
						<div class="col-4">
							...
							<p> <b> Advertisement Types:</b> Bus Stop Advertisement Panel. </p>
								 <a href=""   target="blank"> <button type="button"class="btn" style="background:#9198e5">Detail</button> </a>
							</div> 　							
